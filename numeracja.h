...
void wydrukuj_plik_binarny(const char* nazwa_pliku, int ile_lin, int dl_lin);
...
void odwiedz2(const char* nazwa_pliku, int x, int y, int wart_akt, int liczba_kolumn, int liczba_wierszy);
